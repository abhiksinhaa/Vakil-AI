...
export default function SettingsPage() {
  ...
  const draftLimit = profile?.drafts_limit ?? 30;
            ...
            <section className="card">
              ...
              <div className="grid gap-4 pt-6 sm:grid-cols-2">
                <div className="rounded-3xl border border-border bg-navy/60 p-4">
                  ...
                  <p className="mt-2 font-medium text-cream">{subscription?.plan === 'basic' ? 'Basic Annual' : 'Free'}</p>
                  {isPro ? (
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-3">
                ...
                <button type="button" onClick={() => router.push('/pricing')} className="btn-primary px-4 py-3 text-sm">
                  {subscription?.plan === 'basic' ? 'Upgrade plan' : 'Upgrade to Basic'}
                </button>
              </div>
            </section>
