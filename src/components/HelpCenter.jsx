    ...
    articles: [
      {
        ...
        answer: "Yes. All your data is encrypted and stored securely using Supabase. Row Level Security ensures only you can access your drafts. We never sell your personal data to third parties."
      },
      {
    ...
    <div className="min-h-screen bg-navy flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-4 sm:px-6 py-8 flex flex-col">
        <div className="flex items-center gap-4 mb-8">
          <Link to="/settings" className="p-2 -ml-2 rounded-full hover:bg-gold/10 text-cream/70 hover:text-gold transition-colors">
